  ...
  <div class="alerts-container">
    ...
    <div class="page-header">
      ...
      <div class="header-center">
        ...
        <div>
          <h1>Smart Alert Zones</h1>
          <p>Create custom zones to monitor incidents that matter to you</p>
        </div>
      </div>
      <div class="header-right">
        <button class="create-btn" onclick={() => showCreateModal = true}>
          <Plus size={18} />
          <span>New Alert Zone</span>
        </button>
      </div>
    </div>
      ...
      <div class="stats-row">
        ...
        <div class="stat-card">
          ...
          <div class="stat-content">
            ...
            <span class="stat-label">Total Coverage (km)</span>
          </div>
        </div>
      </div>
          ...
          <div class="form-field">
            ...
            <div class="categories-grid">
              {#each categories as cat}
                {@const isSelected = newAlert.categories.includes(cat.value)}
                <button 
                  type="button"
                  class="category-option {isSelected ? 'selected' : ''}"
                  style={isSelected ? `background: ${cat.bg}; border-color: ${cat.color}; color: ${cat.color};` : ''}
          ...
          <div class="form-field">
            ...
            <div class="severity-group">
              {#each severityLevels as level}
                {@const isSelected = newAlert.severity.includes(level.value)}
                <button 
                  type="button"
                  class="severity-option {isSelected ? 'selected' : ''}"
                  style={isSelected ? `background: ${level.color}; border-color: ${level.color}; color: white;` : ''}

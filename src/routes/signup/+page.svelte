...
<style>
  ...
  .su-progress-step.done .su-step-bubble { background:#1a0b2e; border-color:#1a0b2e; color:white; }
  .su-step-label { font-size:.6875rem; font-weight:500; color:#F59E0B; transition:color .3s; }
  .su-progress-step.active .su-step-label { color:#6a2c91; font-weight:700; }
  .su-progress-step.done .su-step-label { color:#1a0b2e; font-weight:600; }
